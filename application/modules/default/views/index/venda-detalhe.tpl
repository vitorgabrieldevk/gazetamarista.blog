<main id="site-corpo" class="venda-detalhada">
	...
	{if file_exists($banner_existe) && !empty($aviao->banner_desktop)}
		...
		<figure class="uk-cover-container figure-header">
			<img class="uk-visible@s" data-src="{$src}" data-width="1920" data-height="615" uk-img
				alt="{$translate['frota']['nossa_frota']}" uk-cover>
			<img class="uk-hidden@s" data-src="{$src_mobile}" data-width="520" data-height="615" uk-img
				alt="{$translate['frota']['nossa_frota']}" uk-cover>
		</figure>
	{/if}
	...
	<section class="bloco-contato uk-text-center">
		<div class="uk-container">
			<p>{$translate['venda-detalhe']['mensagem-contato']}</p>
