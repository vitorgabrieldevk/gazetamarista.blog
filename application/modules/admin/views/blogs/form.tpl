	...
	<div class="small-12 columns">
		...
		<div class="tabs-content">
			<div class="content active" id="geral">
				...
				<hr>
				<div class="row">
					<div class="small-12 columns seo-preview">
						<span class="preview_title"></span>
						<span class="preview_link"></span>
						<span class="preview_description"></span>
					</div>
				</div>
				
				<hr>
				<div class="row">
					<div class="small-12 columns seo">
						<p>Análise de SEO (* Não esqueça de clicar no botão 'Atualizar' para salvar o post)</p>
						<ul id="seo"></ul>
					</div>
				</div>
			</div>
