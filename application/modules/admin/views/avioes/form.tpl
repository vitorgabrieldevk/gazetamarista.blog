	...
	<div class="small-12 columns">
		...
		<div class="tabs-content">
			<div class="content active" id="geral">
				<input id="idaviao" type="hidden" value="{$id}">
				{$form}
			</div>
			...
			<div class="content" id="vantagem">
				...
				<div class="row">
					<div class="small-12 medium-6 columns end">
						<a href="#" class="button secondary normal btn-add-vantagem"><span class="mdi mdi-content-save-move-outline"></span> Adicionar</a>
				...
				<div class="row">
					...
					<div class="small-12 columns list-vantagens lista-simples" data-type="vantagem">
						{foreach from=$vantagens item="row"}
							<div class="row item-container lista-simples-item" id="{$row->idaviaoitem}">
								<div class="small-2 medium-1 columns">
									<a href="{$basePath}/admin/avioes/deletaritem/idaviao/{$id}/iditem/{$row->idaviaoitem}" title="Excluir item" title="Excluir item" class="btn-remove-vantagem btn_excluir"></a>
								</div>
			...
			<div class="content" id="performance">
				...
				<div class="row">
					<div class="small-12 medium-6 columns end">
						<a href="#" class="button secondary normal btn-add-performance"><span class="mdi mdi-content-save-move-outline"></span> Adicionar</a>
						<p>*Após adicionar, clique em cadastrar/atualizar</p>
				...
				<div class="row">
					...
					<div class="small-12 columns list-performances lista-simples" data-type="performance">
						{foreach from=$performances item="row"}
							<div class="row item-container lista-simples-item" id="{$row->idaviaoitem}">
								<div class="small-2 medium-1 columns">
									<a href="{$basePath}/admin/avioes/deletaritem/idaviao/{$id}/iditem/{$row->idaviaoitem}" title="Excluir item" title="Excluir item" class="btn-remove-performance btn_excluir"></a>
								</div>
								<div class="small-10 medium-11 columns grab">
									<span class="titulo">(PT) {$row->item}</span>
