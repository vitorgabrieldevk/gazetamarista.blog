 ...
 * Modelo da tabela
 *
 * @name Admin_Model_Baseitens
 * @see Zend_Db_Table_Abstract
 */
class Admin_Model_Baseitens extends gazetamarista_Db_Table {
	/**
	 ...
	 * @var string
	 */
	protected $_name = "zend_baseitens";
	...
	public function init() {
		...
		$this->setVisibility("idbase", TRUE, TRUE, TRUE, TRUE);
		...
		$this->setAutocomplete("idbase", "Admin_Model_Bases");
