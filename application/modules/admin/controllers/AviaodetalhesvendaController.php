 ...
 */
class Admin_AviaodetalhesvendaController extends gazetamarista_Controller_Action {
	/**
	 * Armazena o model padrão da tela
	 *
	 * @access protected
	 * @name $_model
	 * @var Admin_Model_Aviaovendadetalhes
	 */
	...
	public function init() {
		...
		$this->_model = new Admin_Model_Aviaovendadetalhes();
