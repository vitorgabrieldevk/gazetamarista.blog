 ...
 *
 * @name Admin_ServicoitensController
 */
class Admin_ServicoitensController extends gazetamarista_Controller_Action {
	/**
	 * Armazena o model padrão da tela
	 *
	 * @access protected
	 * @name $_model
	 * @var Admin_Model_Servicoitens
	 */
	...
	public function init() {
		...
		$this->_model = new Admin_Model_Servicoitens();
