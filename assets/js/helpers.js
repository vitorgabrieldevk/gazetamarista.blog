 ...
 */
export function ajaxGetError(error) {
	let error_type    = "";
...
/**
 * @param num
 * @param {('name'|'abbr'|'short')}  type
 *
 * @returns {string}
 */
export function day_name(num, type = 'name') {
	const names       = ["Domingo", "Segunda-feira", "Terça-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira", "Sábado"];
	const names_abbr  = ["Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sáb"];
	const names_short = ["Domingo", "Segunda", "Terça", "Quarta", "Quinta", "Sexta", "Sábado"];

	if( type === 'abbr' )
	{
		return names_abbr[num];
	}
	else if( type === 'short' )
	{
		return names_short[num];
	}
...
/**
 * @param num
 * @param {('name'|'abbr')}  type
 *
 * @returns {string}
 */
export function month_name(num, type = 'name') {
	const names      = ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"];
	const names_abbr = ["Jan", "Fev", "Mar", "Abril", "Maio", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"];
...
export function diff_in_days(future, pass) {
	let future_ms = future instanceof Date ? future.getTime() : future;
	let pass_ms   = pass instanceof Date ? pass.getTime() : pass;

	const diff = Math.floor(future_ms - pass_ms);
